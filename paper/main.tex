...
\begin{table}[t]
\centering
\caption{Distributed training simulation: head-to-head on H800 LLM workloads (Echo eval~\cite{echo2024}) and large-scale comparison (SimAI eval~\cite{simai2025}). Self-reported accuracy from each tool's own paper. ASTRA-sim error at 512 GPUs is from SimAI's evaluation.}
...
\begin{axis}[
    ...
    ymin=0, ymax=70,
    xtick=data,
    symbolic x coords={NeuSight,Path Fwd,Proteus,ASTRA-sim,Vidur},
    xticklabel style={font=\footnotesize, rotate=35, anchor=east},
    yticklabel style={font=\footnotesize},
    xlabel style={font=\small},
    ylabel style={font=\small},
...
Third-party evaluations consistently show $3$--$11\times$ higher error under challenging conditions.}
