...
Table~\ref{tab:distributed-comparison} compares distributed training simulators using Echo's evaluation~\cite{echo2024} on identical H800 workloads, supplemented by SimAI's comparison~\cite{simai2025} with ASTRA-sim at larger scales.
...
Table~\ref{tab:inference-comparison} compares published accuracy for inference serving simulators.
